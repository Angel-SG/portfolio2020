          ...
          <Col sm={12} md={6} lg={8}>
            <div className="about-main-copy">
              ...
              <div className="copy-section">
                ...
                <p>I enjoy bringing designs and mock-ups to fully functioning web pages by using HTML, CSS and javaScript. I'm flexible when it comes to working or learning frameworks and technologies but my favourites are React and CSS flexbox. I'm also familiar with CMS's like Drupal, Contentful or Wordpress.</p>
